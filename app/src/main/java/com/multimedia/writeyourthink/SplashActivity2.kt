...
import com.multimedia.writeyourthink.databinding.ActivitySplash2Binding
class SplashActivity2 : AppCompatActivity() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            animation.setAnimationListener(object : Animation.AnimationListener {
                ...
                override fun onAnimationEnd(animation: Animation) {
                    ...
                    val intent2 = Intent(this@SplashActivity2, LoginActivity::class.java)
    ...
    private inner class MyAnimationListener : Animation.AnimationListener {
        override fun onAnimationStart(animation: Animation) {}
        override fun onAnimationEnd(animation: Animation) {
            val intent2 = Intent(this@SplashActivity2, MainActivity::class.java)
            startActivity(intent2)
            finish()
        }
